...
public class CameraController : MonoBehaviour
{
    ...
    public float SavedXSen;
    public float SavedYSen;
    ...
    private void Start()
    {
        ...
        SavedXSen = XAxisSensitivity;
        SavedYSen = YAxisSensitivity;
        SavedAcc = AccelerationMod;
    }
    ...
    private void Update()
    {
        ...
        {
            XAxisSensitivity = SavedXSen;
            YAxisSensitivity = SavedYSen;
            AccelerationMod = SavedAcc;
        }
